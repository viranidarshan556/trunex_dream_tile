...
export const upsertTile = createServerFn({ method: "POST" })
  ...
  .inputValidator((d: unknown) =>
    z.object({
      ...
      finish: z.enum(["matte", "glossy", "rustic", "polished", "satin"]),
      size: z.enum(["300x300", "600x600", "600x1200", "800x800", "1200x1200", "1200x2400"]),
      room_types: z.array(z.enum(["bedroom", "living", "kitchen", "bathroom", "outdoor", "office", "commercial"])),
